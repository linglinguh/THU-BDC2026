...
> **版本**: 2.1 | **最后更新**: 2026-07-22 | **适用比赛**: 2026 中国高校计算机大赛—大数据挑战赛
...
> **⚠️ 待确认项**: Docker 基础镜像/服务名/训练时间限制等规范，请选手登录 Heywhale 平台查看完整赛题说明，或与组委邮件确认。
...
| `enable_multi_factor` | bool | True | ✅ | 多因子评分开关 |
| `multi_factor_*_weight` | float | 见 config | ✅ | 因子权重 |
